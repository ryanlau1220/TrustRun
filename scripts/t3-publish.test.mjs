...
assert.equal(isContractVersionAlreadyRegistered(new Error("RPC Error: contract version invalid: version 0.1.2 is not higher than current version 0.1.2")), true);
