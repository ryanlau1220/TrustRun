...
assert.equal(isContractVersionAlreadyRegistered(new Error("RPC Error: contract version invalid: version 0.1.3 is not higher than current version 0.1.3")), true);
